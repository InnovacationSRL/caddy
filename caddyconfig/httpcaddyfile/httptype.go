...
import (
	...
	"github.com/InnovacationSRL/caddy/v2/modules/caddypki"
...
func (st *ServerType) serversFromPairings(
	...
	for i, p := range pairings {
		...
		// See https://github.com/InnovacationSRL/caddy/pull/4728 for a full explanation
		...
		sort.SliceStable(p.serverBlocks, func(i, j int) bool {
			...
			if iWildcardHost != jWildcardHost {
				...
				// https://github.com/InnovacationSRL/caddy/issues/3410
		...
		for _, sblock := range p.serverBlocks {
			...
			// see https://github.com/InnovacationSRL/caddy/issues/3310
		...
		// https://github.com/InnovacationSRL/caddy/issues/3004
...
func normalizeDirectiveName(directive string) string {
	...
	// See https://github.com/InnovacationSRL/caddy/issues/3675#issuecomment-678042377
...
func parseMatcherDefinitions(d *caddyfile.Dispenser, matchers map[string]caddy.ModuleMap) error {
	...
	if d.NextArg() {
		if d.Token().Quoted() {
			...
			// see https://github.com/InnovacationSRL/caddy/issues/6287
